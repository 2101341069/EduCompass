...
<div class="article-banner">
    ...
    <div class="banner-info">
        ...
        <div class="banner-rit">
            <p>
                <a href="http://www.51xuecheng.cn:81/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <#list firstNode.teachPlanTreeNodes as secondNode>
                                            <li><a href="http://www.51xuecheng.cn:81/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>
                                        </#list>
                                    </ul>
                                </div>
                            </div>
